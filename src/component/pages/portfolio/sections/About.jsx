			...
			<SectionLayout sectionTitle='About' dividerIcon={faIdCard}>
				<div className='font-mono space-y-2 whitespace whitespace-break-spaces mb-8 sm:mb-10 md:mb-12'>
					...
					<p>
						...
						and am actively searching for work opportunities. I
						don't have a specific preference for a particular
						technology stack. What matters more to me is being part
						of an organization where I can stay long-term and
						continue learning to become a better engineer.
					</p>
				</div>
