...
const Icons = () => {
    ...
    return (
        <>
            ...
            <div className='grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4 mt-4 mb-8 sm:px-6'>
            ...
            <div className='grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-1 mt-4 mb-8 sm:px-6'>
